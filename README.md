...
│                         credit_risk_analysis and configuration for tools like black
│
...
│
└── credit_risk_analysis   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes credit_risk_analysis a Python module
    │
