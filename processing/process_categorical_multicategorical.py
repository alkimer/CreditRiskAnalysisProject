...
def clean_all_multi(path_train, path_val):
    ...
    # Guardar resultados
    X_train_enc.to_csv('data/interim/X_train_multi.csv', index=False)
    X_val_enc.to_csv('data/interim/X_val_multi.csv', index=False)
...
if __name__ == "__main__":
    clean_all_multi("./data/interim/X_train.csv", "./data/interim/X_val.csv")
